function [vort,x,y,t]=Vorticities(vtracks,framerange,noisy)
% Usage: [vort,x,y,t]=Vorticities(vtracks,[framerange],[noisy])
...
% returned in the vector "vort"; corresponding positions and times are 
...
% also Velocities.m, Divergences.m. This file can be downloaded from 
...
if nargin<1
    error(['Usage: [vort,x,y,t] = ' mfilename '(vtracks,[framerange],[noisy]'])
end
...
y=y(ind);
t=t(ind);
vort=vort(:); % output column vectors
x=x(:);
y=y(:);
t=t(:);
