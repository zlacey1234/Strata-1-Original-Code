...
function [vtracks,ntracks,meanlength,rmslength] = OuelletteTracker3D(pos_lst,max_disp,minarea)
...
% -=- Parse inputs -=-----------------------------------------------------
if nargin<1
    error('Usage: [vtracks,ntracks,meanlength,rmslength] = OuelletteTracker(inputnames,pos_lst,max_disp,[minarea],[noisy])')
end
