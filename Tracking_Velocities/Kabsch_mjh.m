% 1/19/2015: Edited by Matt Harrington to remove component that considers
% translational motion; this can be used to find rotation matrix for two
% orientation vectors pointing outward from the center of a grain
...
%
function[U, lrms] = Kabsch_mjh(P, Q, m)
	sz1 = size(P) ;
	sz2 = size(Q) ;
